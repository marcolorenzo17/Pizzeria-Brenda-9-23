<x-app-layout>
    ...
    <div class="container px-12 py-8 mx-auto bg-white" style="margin-bottom:300px;">
        ...
        <br><br>
        <p style="font-weight: bolder; font-size:22px;">{{ __('¿Hay servicio a domicilio fuera de Chipiona?') }}</p><br>
        ...
        <br><br>
        <p style="font-weight: bolder; font-size:22px;">{{ __('¿Cuánto cuesta el servicio a domicilio?') }}</p><br>
