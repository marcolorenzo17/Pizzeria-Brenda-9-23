...
<body class="antialiased" style="background-color:#141414; margin:20px;">
    <div style="background-color:#f5f0e9;">
        ...
        <div class="container px-12 py-8 mx-auto bg-white" style="padding:30px; margin-top:200px; margin-bottom:300px;">
            ...
            <br><br>
            <p style="font-weight: bolder; font-size:20px;">{{ __('¿Hay servicio a domicilio fuera de Chipiona?') }}
            </p>
            <br>
