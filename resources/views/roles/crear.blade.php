    ...
    @if (in_array('3', $privilegioslista) || Auth::user()->primero)
        <x-app-layout>
            ...
            <div class="container px-12 py-8 mx-auto bg-white"
                ...
                <div>
                    <form action="{{ route('roles.aniadir') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div id="input_div" style="margin:auto; display:block;">
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name') }}"
                                onfocusout="validate_name()" style="width:100%; border-radius:30px;">
                        ...
                        <div id="input_div" style="margin:auto; display:block;">
                            ...
                            <input type="text" id="nameen" name="nameen" size="80"
                                value="{{ old('nameen') }}" onfocusout="validate_nameen()" style="width:100%; border-radius:30px;">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <label
                                            for="5">{{ __('El usuario puede borrar valoraciones') }}</label><br>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        ...
                                        <label
                                            for="6">{{ __('El usuario puede borrar comentarios') }}</label><br>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
