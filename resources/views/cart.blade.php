                            ...
                            <tbody>
                              ...
                              <tr>
                                <td class="hidden pb-4 md:table-cell">
                                  <a href="#">
                                    <img src="{{ $item->attributes->foto }}" class="w-20 rounded" alt="Thumbnail">
                                  </a>
                                </td>
                                <td>
                                  <a href="#">
                                    <p class="mb-2 md:ml-4 text-purple-600 font-bold">{{ $item->nombre_plato }}</p>
                                ...
                                <td class="justify-center mt-6 md:justify-end md:flex">
                                  <div class="h-10 w-28">
                                    <div class="relative flex flex-row w-full h-8">
                                      ...
                                      <input type="text" name="quantity" value="{{ $item->cantidad }}"
